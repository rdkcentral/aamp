...
{
	eCURLINSTANCE_VIDEO, // 0
	eCURLINSTANCE_AUDIO, // 1
	eCURLINSTANCE_SUBTITLE, // 2
	eCURLINSTANCE_MANIFEST_MAIN, // 3
	eCURLINSTANCE_MANIFEST_PLAYLIST_VIDEO, // 4
	eCURLINSTANCE_MANIFEST_PLAYLIST_AUDIO, // 5
	eCURLINSTANCE_MANIFEST_PLAYLIST_SUBTITLE, // 6
	eCURLINSTANCE_DAI, // 7
	eCURLINSTANCE_AES, // 8
	eCURLINSTANCE_PLAYLISTPRECACHE, // 9
	eCURLINSTANCE_MAX // 10
};
