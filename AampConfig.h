...
typedef enum
{
	...
	eAAMPConfig_DnsCacheBypassThreshold,			/**< Number of consecutive DNS failures before bypassing cache */
	eAAMPConfig_DnsRetryWaitTimeMs,					/**< Wait time in milliseconds before retry on DNS failure */
