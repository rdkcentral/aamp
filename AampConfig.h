...
typedef enum
{
	...
	eAAMPConfig_LLDrmLatencyEstimateSec,			/**< LL-DASH: estimated DRM acquisition latency (s); reduces initial live offset on a new tune when DRM is not cached; 0 disables feature */
