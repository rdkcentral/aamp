...

{
	...
	if(privateContext)
	{
		...
		AAMPLOG_ERR("Nithya: Calling SetLoggerInfo with the following parameters in aampgstplayer.cpp:\n");
		AAMPLOG_ERR("Nithya: disableLogRedirection: %s\n", AampLogManager::disableLogRedirection ? "true" : "false");
		AAMPLOG_ERR("Nithya: enableEthanLogRedirection: %s\n", AampLogManager::enableEthanLogRedirection ? "true" : "false");
		AAMPLOG_ERR("Nithya: aampLoglevel: %d\n", AampLogManager::aampLoglevel);
		AAMPLOG_ERR("Nithya: locked: %s\n", AampLogManager::locked ? "true" : "false");
