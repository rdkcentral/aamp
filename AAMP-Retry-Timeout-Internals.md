...
This document describes how AAMP handles retries and timeouts for media segment and manifest downloads, covering both HTTP error codes and curl-level failures.
