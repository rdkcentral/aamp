...
public:
    ...
    AampGrowableBuffer(const AampGrowableBuffer&);
    AampGrowableBuffer& operator=(const AampGrowableBuffer&);
    void Free( void );
    ...
    char *GetPtr( void ) const { return (char *)ptr; } // accessor function for current growable buffer binary payload
