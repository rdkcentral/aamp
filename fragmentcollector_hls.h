...
class TrackState : public MediaTrack
{
	...
	public:
		...
		AampTime playTargetBufferCalcCulled; 	 /**< When seeking the position takes into account the culled seconds, this needs applying subsequently when adjusting playTargetBufferCalc */
