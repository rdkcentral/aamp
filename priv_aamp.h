...
public:
	...
	*/
	 ...
	 */
	void SendAdResolvedEvent(const std::string &adId, bool status, uint64_t startMS=0, uint64_t durationMs=0,uint64_t mErrorCode=0,const std::string &mErrorDescription="");
