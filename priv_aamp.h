...
public:
	...
	*/
	 ...
	 */
	bool _GetLLDashChunkMode() { return mIsChunkMode; }
	...
	*/
	 ...
	 */
	void _SendMonitorAvEvent(const std::string &status, int64_t videoPositionMS, int64_t audioPositionMS, uint64_t timeInStateMS);
