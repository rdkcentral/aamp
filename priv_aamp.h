...
public:
	...
	*/
	 ...
	 *   @return void
	 */
	void SendStreamTransfer(AampMediaType mediaType, std::vector<uint8_t>* buffer, double fpts, double fdts, double fDuration, double fragmentPTSoffset, bool initFragment = 0, bool discontinuity = false);
