...
typedef enum
{
	...
	PROFILE_BUCKET_GST_VIDEO_SINK_ADD,    /**< Video sink element added to pipeline bucket*/
	PROFILE_BUCKET_GST_AUDIO_SINK_ADD,    /**< Audio sink element added to pipeline bucket*/
	PROFILE_BUCKET_SINKBIN_ADD_TO_PIPELINE,  /**< Sinkbin added to pipeline bucket*/
	PROFILE_BUCKET_ELEMENT_SETUP_CB_ADD,   /**< Element setup callback for demux bucket*/
