...
#define MIN_MONITOR_AV_DELTA_MS 1 	/**< minimum delta to trigger MonitorAV reportings*/
#define MAX_MONITOR_AV_DELTA_MS 10000 	/**< maximum delta to trigger MonitorAV reportings*/
