...
uint64_t StreamAbstractionAAMP_MPD::AdjustStartTimeWithPTO(const Timeline* timeline, uint64_t presentationTimeOffset)
{
    ...
    {
        AAMPLOG_WARN("StreamAbstractionAAMP_MPD: Presentation Time Offset %" PRIu64 " ahead of segment start Time %" PRIu64 ", Set PTO as segment start", presentationTimeOffset, startTime);
        startTime = presentationTimeOffset;
    }
    return startTime;
}