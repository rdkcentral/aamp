...
do
	...
	if [ $RUN_DASH -eq 1 ]; then
		ffmpeg -hide_banner -y -i ${AUDIO_PATH}/${LANG_639_2[$I]}/full_track.wav -map 0:a -c:a $AUDIO_CODEC -b:a 384k -ar 48000 -t $VIDEO_LENGTH_SEC  -seg_duration $((VIDEO_SEGMENT_SEC)) -use_timeline 1 -use_template 1 -init_seg_name $DASH_OUT/${LANG_639_2[$I]}_init.m4s -media_seg_name $DASH_OUT/${LANG_639_2[$I]}_'$Number%03d$.mp3'  -f dash ${LANG_639_2[$I]}.mpd
	fi
    fi
done
