            ...
            with open(os.path.join(log_directory, log_file), "r") as file:
                ...
                if lines:
                    ...
                    while current_line < len(lines):
                        if "[TST_START]" in lines[current_line]:
                            suite_name = lines[current_line].split()[-1]
                        elif "[TST_STEP]" in lines[current_line]:
                            classname = f"{suite_name}"
                            total_tests += 1
                            parts = lines[current_line].split()
                            step_status = parts[-1]

                            current_step = " ".join(parts[5:-1])
                            ...
                            while current_step == step_description:
                                ...
                                parts = lines[current_line].split()
                                step_description = " ".join(parts[5:-1])
                            ...
                            step_description = step_description[:len(step_description) - 1]
...
def parse_log_files_to_json(log_directory, output_file):
        ...
        if log_file.endswith(".txt"):
            ...
            with open(os.path.join(log_directory, log_file), "r") as file:
                ...
                if lines:
                    while current_line < len(lines):
                        if "[TST_START]" in lines[current_line]:
                            testsuite_name = lines[current_line].split()[-1]
    ...
    report["test_cases_results"]["time"] = "0s"
