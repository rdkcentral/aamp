...
/// Definition of the global declared in MockIMediaPipelineCapabilities.h.
std::shared_ptr<MockIMediaPipelineCapabilitiesFactory> g_mockCapabilitiesFactory;
...
{
	return g_mockCapabilitiesFactory;
}
