...
public:
	...
	MOCK_METHOD(double, getFirstPts, (std::vector<uint8_t>* pBuffer), (override));
	MOCK_METHOD(void, setPtsOffset, (double ptsOffset), (override));
	MOCK_METHOD(bool, sendSegment, (std::vector<uint8_t>* pBuffer, double position, double duration, double fragmentPTSoffset, bool discontinuous, bool isInit, process_fcn_t processor, bool &ptsError), (override));
