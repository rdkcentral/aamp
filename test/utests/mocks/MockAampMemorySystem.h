...
#ifndef AAMP_MOCK_AAMP_MEMORY_SYSTEM_H
#define AAMP_MOCK_AAMP_MEMORY_SYSTEM_H

#include <gmock/gmock.h>
#include "AampMemorySystem.h"

class MockAampMemorySystem  : public AAMPMemorySystem
{
public:
...
#endif /* AAMP_MOCK_AAMP_MEMORY_SYSTEM_H */