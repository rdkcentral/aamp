...
public:
	...
	MOCK_METHOD(void, SendAdResolvedEvent, (const std::string &adId, bool status, uint64_t startMS, uint64_t durationMs,uint64_t errorCode,(const std::pair<std::string, std::string> &errorDescription)));
