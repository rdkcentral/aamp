...
class MockAampDrmHelper : public AampDrmHelper
{
public:
	...
	MOCK_METHOD(void, generateLicenseRequest, (const AampChallengeInfo& challengeInfo, AampLicenseRequest& licenseRequest), (const, override));

	MOCK_METHOD(void, transformLicenseResponse, (std::shared_ptr<DrmData> licenseResponse), (const, override));

    MOCK_METHOD(AAMPMemorySystem*, getMemorySystem, (), (override));
