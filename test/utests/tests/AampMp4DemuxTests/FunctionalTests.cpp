...
TEST_F(AampMp4DemuxerTests, TrickplayPtsRestamp_InitFragmentStateReset)
{
	...
	bool ptsError = false;
	bool result = mDemuxer->sendSegment(initBuffer, 0.0, 0.0, 0.0, false, true, nullptr, ptsError);
...
TEST_F(AampMp4DemuxerTests, TrickplayPtsRestamp_FirstMediaFragment)
{
	...
	bool ptsError = false;
	mDemuxer->sendSegment(initBuffer, 0.0, 0.0, 0.0, false, true, nullptr, ptsError);
	...
	bool result = mDemuxer->sendSegment(mediaBuffer, 0.0, kFragmentDuration, 0.0, false, false, nullptr, ptsError);
...
TEST_F(AampMp4DemuxerTests, TrickplayPtsRestamp_RewindModeMultipleFragments)
{
	...
	for (int i = 0; i < 3; i++)
	{
		...
		mDemuxer->sendSegment(mediaBuffer, 0.0, kFragmentDuration, 0.0, false, false, nullptr, ptsError);
	}
...
TEST_F(AampMp4DemuxerTests, TrickplayPtsRestamp_NormalToTrickplayTransition)
{
	...
	bool ptsError = false;
	mDemuxer->sendSegment(mediaBuffer, 0.0, 2.0, 0.0, false, false, nullptr, ptsError);
	...
	mDemuxer->sendSegment(media2Buffer, 0.0, 2.0, 0.0, false, false, nullptr, ptsError);
	...
	mDemuxer->sendSegment(media3Buffer, 0.0, 2.0, 0.0, false, false, nullptr, ptsError);
}
...
TEST_F(AampMp4DemuxerTests, TrickplayPtsRestamp_NoDuplicateInitAtSameRate)
{
	...
	bool ptsError = false;
	mDemuxer->sendSegment(init1Buffer, 0.0, 0.0, 0.0, false, true, nullptr, ptsError);
	...
	mDemuxer->sendSegment(media1Buffer, 0.0, 2.0, 0.0, false, false, nullptr, ptsError);
	...
	mDemuxer->sendSegment(init2Buffer, 0.0, 0.0, 0.0, false, true, nullptr, ptsError);
