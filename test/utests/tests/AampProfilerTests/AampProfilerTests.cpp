...
{
    ProfileEventAAMP profileEvent;
    ProfilerBucketType profilesList[40] = {
    ...
    PROFILE_BUCKET_STOP_FC_VIDEO,
	PROFILE_BUCKET_STOP_FC_AUDIO,
    PROFILE_BUCKET_STOP_INJECTOR_VIDEO,
    PROFILE_BUCKET_STOP_INJECTOR_AUDIO,
    PROFILE_BUCKET_RELEASE_DRM,
    PROFILE_BUCKET_DESTROY_PIPELINE,
    PROFILE_BUCKET_STOP_RATE_CORRECTION,
    PROFILE_BUCKET_STOP_MONITOR_VIDEO,
	PROFILE_BUCKET_STOP_MONITOR_AUDIO,
    PROFILE_BUCKET_STOP_PREFETCH_THREAD,
    PROFILE_BUCKET_STOP_MANIFEST_DOWNLOADER,
    PROFILE_BUCKET_STOP_TOTAL,
...
TEST_F(AampProfilertests, ProfileEndTest1)
{
    ...
    profileEvent->ProfileBegin(PROFILE_BUCKET_MANIFEST);    
    profileEvent->ProfileEnd(PROFILE_BUCKET_TYPE_COUNT);
    EXPECT_EQ(PROFILE_BUCKET_TYPE_COUNT,39);
}
...
{
    ProfileEventAAMP profileEvent;
    ProfilerBucketType ProfilePerformedList[40] = {
    PROFILE_BUCKET_MANIFEST,
    PROFILE_BUCKET_PLAYLIST_VIDEO,
    PROFILE_BUCKET_PLAYLIST_AUDIO,
    PROFILE_BUCKET_PLAYLIST_SUBTITLE,
...
TEST_F(AampProfilertests, TuneStopTests)
{
    profileEvent->LogStopTime("DASH");
}