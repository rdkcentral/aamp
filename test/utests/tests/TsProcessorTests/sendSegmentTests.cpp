...
TEST_F(sendSegmentTests, SendSegmentTest)
{
    ...
    buf.assign(reinterpret_cast<const uint8_t*>(segment), reinterpret_cast<const uint8_t*>(segment) + size);
    double position = 0.0;
...
TEST_F(sendSegmentTests, esMP3test)
{
    ...
    buffer.assign(reinterpret_cast<const uint8_t*>(segment), reinterpret_cast<const uint8_t*>(segment) + sizeof(segment));
