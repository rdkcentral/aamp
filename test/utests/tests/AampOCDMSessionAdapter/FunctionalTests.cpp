...
class AampOCDMSessionAdapterTests : public ::testing::Test
{

protected:
	AAMPOCDMSessionAdapter *m_aampocdmsessionadapter = nullptr;
	...
	void SetUp() override
	{
		...
		m_aampocdmsessionadapter = new AAMPOCDMSessionAdapter(drmHelper, nullptr);
	}

	void TearDown() override
	{
		delete m_aampocdmsessionadapter;
		m_aampocdmsessionadapter = nullptr;
...
TEST_F(AampOCDMSessionAdapterTests, generateAampDRMSession)
{
	...
	m_aampocdmsessionadapter->generateAampDRMSession(initData, f_cbInitData, customData);
}