...
<MPD xmlns="urn:mpeg:dash:schema:mpd:2011"
  ...
  <Period id="Period-4">
    ...
    EXPECT_CALL(*g_mockPrivateInstanceAAMP,
        FoundEventBreak(std::string("Period-2"), 1800000ULL, _)).Times(1);
    EXPECT_CALL(*g_mockPrivateInstanceAAMP,
        SaveNewTimedMetadata(1800000LL, StrEq("Period-2"), 30000.0)).Times(1);

    // Period-4 (EAP): timeStartMS = Period-3 start (3600000) + GetPeriodDuration(period 3) (20000) = 3620000 ms.
    EXPECT_CALL(*g_mockPrivateInstanceAAMP,
        FoundEventBreak(std::string("Period-4"), 3620000ULL, _)).Times(1);
    EXPECT_CALL(*g_mockPrivateInstanceAAMP,
        SaveNewTimedMetadata(3620000LL, StrEq("Period-4"), 30000.0)).Times(1);
