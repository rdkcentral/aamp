...
// Per-sample info table (default_sample_info_size == 0) with room to insert a skip box.
static const uint8_t saizTablePresent[] = {
    0x00, 0x00, 0x00, 0x23,  's',  'a',  'i',  'z', 0x00, 0x00, 0x00, 0x01,
    0x63, 0x65, 0x6e, 0x63, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x0a, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0a};

static const uint8_t saizTablePresent_expected[] = {
    0x00, 0x00, 0x00, 0x1a,  's',  'a',  'i',  'z', 0x00, 0x00, 0x00, 0x01,
    0x63, 0x65, 0x6e, 0x63, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x01, 0x01,
    0x00, 0x00, 0x00, 0x09,  's',  'k',  'i',  'p', 0x0a};

// default_sample_info_size layout with sample_count == 0 (guards size arithmetic).
static const uint8_t saizDefaultInfoZeroSamples[] = {
    0x00, 0x00, 0x00, 0x19,  's',  'a',  'i',  'z', 0x00, 0x00, 0x00, 0x01,
    0x63, 0x65, 0x6e, 0x63, 0x00, 0x00, 0x00, 0x00, 0x10, 0x00, 0x00, 0x00,
    0x00};

// Empty per-sample table (default_sample_info_size == 0, sample_count == 0).
static const uint8_t saizEmptyTableZeroSamples[] = {
    0x00, 0x00, 0x00, 0x19,  's',  'a',  'i',  'z', 0x00, 0x00, 0x00, 0x01,
    0x63, 0x65, 0x6e, 0x63, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00};
