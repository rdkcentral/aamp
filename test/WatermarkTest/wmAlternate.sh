...
echo "launch";
curl -X POST -H "Content-Type: application/json" 'http://127.0.0.1:9998/jsonrpc' -d '{"jsonrpc": "2.0","id": 4,"method": "org.rdk.RDKShell.1.launch", "params": {"callsign":"htmlapp1","type": "HtmlApp","uri":"http://10.169.1.102:80/wmAlternate.html"}}';
echo;
