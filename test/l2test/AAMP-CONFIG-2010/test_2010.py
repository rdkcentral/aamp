...
TESTDATA1 = {
    ...
    "expect_list": [
        ...
        {"cmd": "getconfig"},
        {"expect": r'"disableEC3":true.*"disableATMOS":true.*"stereoOnly":true.*"disableAC3":true'},
...
TESTDATA2 = {
    ...
    "expect_list": [
        ...
        {"cmd": "https://cpetestutility.stb.r53.xcal.tv/VideoTestStream/public/aamptest/streams/audiomultichannel/dolby_and_stereo_stream/stream.mpd"},
        {"cmd": "getconfig"},
        {"expect": r'"disableEC3":false.*"disableATMOS":false.*"stereoOnly":false.*"disableAC3":false'},
