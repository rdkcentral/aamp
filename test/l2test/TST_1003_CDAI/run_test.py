...
"expect_list": [
   {"cmd":"new"},
   {"expect":"Undefined Pipeline mode, creating GstPlayer for PLAYER\[1\]"},
   {"cmd":"new"},
   {"expect":"Undefined Pipeline mode, creating GstPlayer for PLAYER\[2\]"},
   {"cmd":"new"},
   {"expect":"Undefined Pipeline mode, creating GstPlayer for PLAYER\[3\]"},
   {"cmd":"new"},
   {"expect":"Undefined Pipeline mode, creating GstPlayer for PLAYER\[4\]"},
   {"cmd":"autoplay"},
   {"cmd":"select 1"},
   ...
   {"cmd":"play"},
   {"expect":"Undefined Pipeline, forcing to Multi Pipeline PLAYER\[2\]"},
   ...
   {"expect":"selected player 3"},
   {"cmd":"play"},
   {"expect":"Multi Pipeline mode, do nothing PLAYER\[3\]"},
   {"expect":"NotifyFirstBufferProcessed"},
   {"cmd":"select 2"},
   {"expect":"selected player 2"},
   {"cmd":"stop"},
   ...
   {"expect":"selected player 4"},
   {"cmd":"play"},
   {"expect":"Multi Pipeline mode, do nothing PLAYER\[4\]"},
   {"expect":"NotifyFirstBufferProcessed"},
   {"cmd":"select 3"},
   {"expect":"selected player 3"},
   {"cmd":"stop"},
   ...
   {"expect":"selected player 1"},
   {"cmd":"play"},
   {"expect":"Multi Pipeline mode, do nothing PLAYER\[1\]"},
   {"expect":"NotifyFirstBufferProcessed"},
   {"cmd":"select 4"},
   {"expect":"selected player 4"},
   {"cmd":"stop"},
