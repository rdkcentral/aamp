...
"expect_list": [
    ...
    {"expect": "Got next fragment url http://simlinear:8085/testdata/m3u8s/../video/1080_4800000/hls/segment_40.ts",
     "min": 100, "max": 135, "callback": add_rule,"callback_arg": ["token3", ".*video/.*_41.ts", "503", "1"]},
    {"expect": "AAMPLogNetworkError error='http error 503' type='VIDEO' location='unknown' symptom='freeze/buffering' url='http://simlinear:8085/testdata/video/1080_4800000/hls/segment_41.ts'",
     "min": 100, "max": 143},
    {"expect": "Download failed due to Server error. Retrying Attempt",
     "min": 100, "max": 143},
