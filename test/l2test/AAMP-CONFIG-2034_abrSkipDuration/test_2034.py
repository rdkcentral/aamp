...
TESTDATA1 = {
    ...
    "expect_list": [
        ...
        {"expect" : r"video - injected cached fragment at pos 8\.[0-9]{6} dur [0-9]\.[0-9]{6}"},
...
TESTDATA2 = {
    ...
    "expect_list": [
        ...
        {"expect" : r"video - injected cached fragment at pos 8\.000000 dur [0-9]\.000000"}, 
        {"expect" : r"Returning Position as [1-3][0-9]{3}"}, 
        {"expect" : r"Returning Position as [4-6][0-9]{3}"}, 
    ],
}
...
TESTDATA3 = {
    ...
    "expect_list": [
        ...
        {"expect" : r"NotifyBitRateChangeEvent \:: bitrate:5000000 desc:BitrateChanged - Network adaptation width:1920"},
        {"expect" : r"video - injected cached fragment at pos [0-9]{1,2}\.[0-9]{6} dur [0-9]\.[0-9]{6}"},
