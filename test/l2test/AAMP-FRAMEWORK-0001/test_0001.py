...
TESTDATA1 = {
    ...
    "expect_list": [
        ...
        {"expect": r"Returning Position as 168926281[1-4](\d{3})"},
        {"expect": r"Returning Position as 168926281[5-9](\d{3})"},
        {"expect": r"Returning Position as 168926282[0-4](\d{3})"},
    ],
}
...
def test_0001(aamp_setup_teardown, test_data):
