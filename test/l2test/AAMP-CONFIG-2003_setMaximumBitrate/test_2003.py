...
TESTDATA0 = {
	...
	{"expect": "Video Profile added to ABR, userData=0 BW=800000"},
        {"expect": "inserted playlist_video https://cpetestutility.stb.r53.xcal.tv/VideoTestStream/hls/360p.m3u8"},
	{"expect": "AAMP_EVENT_TUNED"},
        {"expect": 'IP_AAMP_TUNETIME.*"vfb":800000'},
	{"cmd": "stop"},
	...
	{"expect": "inserted init_video https://cpetestutility.stb.r53.xcal.tv/VideoTestStream/dash/360p_init.m4s"},
	{"expect": "AAMP_EVENT_TUNED"},
        {"expect": 'IP_AAMP_TUNETIME.*"vfb":800000'},
	{"cmd": "stop"},
        {"expect": "aamp_stop PlayerState"}
