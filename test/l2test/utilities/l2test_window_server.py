...
class TestServer(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        keyEqualsValuePattern = re.compile(r"([^=]+)=([^=]+)")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--force404", type=str, help="force HTTP 404 for the urls matching the regex provided")
    ...
    if args.force404:
        TestServer.params.force404 = args.force404
