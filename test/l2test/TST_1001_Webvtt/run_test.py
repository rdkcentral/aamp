...
if platform.system() == 'Darwin':
    AAMP_ENV.update({"GST_PLUGIN_PATH": os.path.join(AAMP_HOME, "build", "Debug", "lib", "gstreamer-1.0")})
    AAMP_CLI_PATH=os.path.join(AAMP_HOME, "build", "Debug", "aamp-cli")
else:
    AAMP_ENV.update({"LD_PRELOAD": os.path.join(AAMP_HOME, "Linux", "lib", "libdash.so"), "LD_LIBRARY_PATH": os.path.join(AAMP_HOME, "Linux", "lib"), "GST_PLUGIN_PATH": os.path.join(AAMP_HOME, "Linux", "lib", "gstreamer-1.0")})
