...
TESTDATA1 = {
	...
	"expect_list": [
		...
		{"expect":r"0.000000 discontinuity 1 pto 0.000000 scale 0 duration 0.000000 mPTSOffsetSec 0.000000 absTime 60.000000 fragmentUrl http://localhost:8085/discontinuityTestStream/dash.akamaized.net/dash264/TestCasesIOP33/multiplePeriods/2/../../Content/.*_init.mp4"},
		{"cmd":"seek 58"},
