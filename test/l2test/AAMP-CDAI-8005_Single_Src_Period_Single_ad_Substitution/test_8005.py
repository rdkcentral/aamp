...
TESTDATA1 = {
    ...
    "expect_list": [
        ...
        {"expect": re.escape("Period ID changed from '0' to '0-111' [BasePeriodId='1']"), "max": 180},
        ...
        {"expect": re.escape("Period ID changed from '0-111' to '2' [BasePeriodId='2']"), "min": 00, "max": 180},
        #Ensure that the first segment of ad is correctly fetched
        {"expect": r"aamp url:0,0,0,2.000000,http://localhost:8080/content/ad_30/*?(1080|720|480|360)p_001.m4s", "max": 180},
        #Ensure that the last  segment of ad is correctly fetched 
        {"expect": r"aamp url:0,0,0,2.000000,http://localhost:8080/content/ad_30/*?(1080|720|480|360)p_015.m4s", "max": 180},
