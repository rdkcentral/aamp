...
"expect_list": [
   ...
   {"expect": r"\[AAMPCLI\] AAMP_EVENT_PROGRESS.*position=0.000s.*currRate=0.0.*currentPlayRate=0.0"},
   {"cmd": "sleep 1000"},
   ...
   {"expect": r"\[AAMPCLI\] AAMP_EVENT_PROGRESS.*currRate=1.0.*currentPlayRate=1.0"},
   {"cmd": "sleep 1000"},
   {"expect": r"sleep complete"},
   {"cmd": "stop"},
   ...
   {"expect": r"\[AAMPCLI\] AAMP_EVENT_STATE_CHANGED: PAUSED"},
   {"expect": r"\[AAMPCLI\] AAMP_EVENT_SPEED_CHANGED current rate=0.000000"},
   {"expect": r"\[AAMPCLI\] AAMP_EVENT_PROGRESS.*position=10.000s.*currRate=0.0.*currentPlayRate=0.0"},
   {"cmd": "sleep 1000"},
   {"expect": r"sleep complete"},
