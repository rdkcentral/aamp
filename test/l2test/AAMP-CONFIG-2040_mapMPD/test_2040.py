...
TESTDATA1 = {
	# AAMP tries to find mpd file having same name as the HLS stream and if mpd file is available then it downloads the mpd file and playbacks the same.
	"title": "Set mapMPD as cpetestutility",
	"logfile": "mapMPD_cpetestutility.txt",
	"max_test_time_seconds": 15,
	"aamp_cfg": f"info=true\ntrace=true\nprogress=true\nmapMPD=cpetestutility.stb.r53.xcal.tv\n",
	"expect_list": [
		{"cmd":r"https://cpetestutility.stb.r53.xcal.tv/VideoTestStream/main.m3u8"},
		# Found .mpd file with same name hence downloaded mpd file & parsed it.
		...
		# Downloaded media segments as mentioned in .mpd file
...
TESTDATA2 = {
	# AAMP tries to find mpd file having same name but since the domains are different, it continues the playback of HLS stream passed to it.
	"title": "Set mapMPD as localhost",
	"logfile": "mapMPD_localhost.txt",
	"max_test_time_seconds": 15,
	"aamp_cfg": f"info=true\ntrace=true\nprogress=true\nmapMPD=localhost\n",
	"expect_list": [
		{"cmd":r"https://cpetestutility.stb.r53.xcal.tv/VideoTestStream/main.m3u8"},
		# Same HLS is downloaded and parsed
		{"expect":r"Inserted. url https://cpetestutility.stb.r53.xcal.tv/VideoTestStream/main.m3u8"},
...
def test_2040(aamp_setup_teardown, test_data):
