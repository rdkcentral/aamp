...
## Test Files
+ test_8012.py  Causes aamp-cli to play manifest and check logs for cdai related logs.
...
1. Streams for this test will be downloaded from https://cpetestutility.stb.r53.xcal.tv
   but location can be overridden by specifying TEST_8012_STREAM_PATH if required.

    a. When running inside docker: -

         echo "TEST_8012_STREAM_PATH=https://artifactory.host.com/artifactory/stream_data.gz" >> .env

    b. When running on ubuntu (outside a docker container): -

        export TEST_8012_STREAM_PATH=https://artifactory.host.com/artifactory/stream_data.gz
