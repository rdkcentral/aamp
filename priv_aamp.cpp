...
void PrivateInstanceAAMP::TuneHelper(TuneType tuneType, bool seekWhilePaused)
{
	...
	else
	{
		...
		*/
		...
		AAMPLOG_MIL("[INBAND_CC_FLOW] previousCCEnabled:%d isCCinBand:%d subtitles_muted:%d mCCStatusSetByApp:%d",
...
void PrivateInstanceAAMP::SetCCStatusInternal(void)
{
	...
	if (mpStreamAbstractionAAMP)
	{
		...
		AAMPLOG_INFO("[INBAND_CC_FLOW] SetCCStatusInternal: mIsInbandCC %d GstSubtecEnabled %d mute_subtitles_applied %d video_muted %d subtitles_muted %d",
