...
struct AsyncEventDescriptor
{
    ...
    AAMPEventPtr event;
    std::shared_ptr<PlayerInstanceAAMP> aamp;
};
...
public:    
    ...
    double _GetPositionRelativeToSeekSeconds(void){return static_cast<double>(GetPositionRelativeToSeekMilliseconds())/1000.0;;}
     ...
     * @return True or False
     */
    bool _IsInProgressCDVR() {return (IsLive() && _IsCDVRContent());}
     ...
     * @return True or False
     */
    bool _IsUninterruptedTSB() {return (_IsFogTSBSupported() && !IsLive());}
     ...
     */
    //PlayerInstanceAAMP(AampConfig *config=NULL);
     ...
     *
     */
    //PlayerInstanceAAMP(const PlayerInstanceAAMP&) = delete;
    
    /**
     * @brief assignment operator disabled
     *
     */
    //PlayerInstanceAAMP& operator=(const PlayerInstanceAAMP&) = delete;
     ...
     */
    void _SetScheduler(AampScheduler *instance) { _mScheduler = instance; }
     ...
     */
    bool DiscontinuitySeenInAllTracks(void);

    /**
     * @brief Check if discontinuity processed in any track
     * @note not part of public API
     */
    bool DiscontinuitySeenInAnyTracks(void);
...
protected:
    ...
    AampScheduler *_mScheduler;         /**< instance to schedule async tasks */
