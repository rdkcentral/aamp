	...
	public:
		...
		/**
        	...
        	*/
        	 ...
        	 */
			bool SendHelper(int type, MediaSample&& sample, bool initFragment, bool &discontinuity, bool &notifyFirstBufferProcessed, bool &resetTrickUTC, bool &firstBufferPushed);
