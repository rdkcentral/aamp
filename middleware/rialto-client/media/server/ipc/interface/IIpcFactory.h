...
#ifndef FIREBOLT_RIALTO_SERVER_IPC_I_IPC_FACTORY_H_
#define FIREBOLT_RIALTO_SERVER_IPC_I_IPC_FACTORY_H_
...
public:
    ...
    virtual std::unique_ptr<IApplicationManagementServer>
...
#endif // FIREBOLT_RIALTO_SERVER_IPC_I_IPC_FACTORY_H_
