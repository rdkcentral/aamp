...
2. Unit tests are updated to use external middleware headers/libs
...
# Clone middleware-player-interface next to the aamp directory
git clone https://github.com/rdkcentral/middleware-player-interface.git

# Option 2: Specify explicit path
./scripts/install-aamp.sh --middleware-player-interface-local-path=/custom/path/middleware-player-interface
...
- **Phase 2 (TBD)**: Update unit tests to use external middleware
